...
Negotiator._makeOffer = function(connection) {
  ...
  if(Promise.resolve(pc.createOffer(connection.options.constraints))==pc.createOffer(connection.options.constraints)){
...
Negotiator._makeAnswer = function(connection) {
  ...
  pc.createAnswer(function(answer) {
    ...
    alert('a');
    try{
    	pc.setLocalDescription(answer, localSuccess, localError);
    	alert('b');
    }catch(e){
    	alert('c');
